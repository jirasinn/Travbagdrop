        ...
        <div class="col-4" style="margin-top: -3%;">
            ...
            <?php
                                if ($row) {
                                    $status = $row['status'];
                                    if ($status == 'approve') {
                                        echo '<div style="display: flex; justify-self: center; "><input type="submitP"  value="เปิดให้บริการ"></div>';
                                    } elseif ($status == 'closed') {
                                        echo '<input type="text1" value="' . $row["cause"] . '" readonly>';
                                        echo '<div style="display: flex; justify-self: center;"><input type="submitC" value="ปิดให้บริการ"></div>';
                                    } elseif ($status == 'not_approve') {
                                        echo '<input type="text1" value="' . $row["cause"] . '" readonly>';
                                        echo '<div style="display: flex; justify-self: center;"><input type="submitN" value="ไม่อนุมัติการเป็นพาร์ทเนอร์"></div>';
                                    } elseif ($status == 'cancel') {
                                        echo '<input type="text1" value="' . $row["cause"] . '" readonly>';
                                        echo '<div style="display: flex; justify-self: center;"><input type="submitN" value="ยกเลิกการเป็นพาร์ทเนอร์"></div>';
                                    }
                                }
            ?>
        </div>
